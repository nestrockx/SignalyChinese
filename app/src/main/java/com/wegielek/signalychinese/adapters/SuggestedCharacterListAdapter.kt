...
class SuggestedCharacterListAdapter(private val charactersRecyclerViewListener: CharactersRecyclerViewListener?) :
    RecyclerView.Adapter<SuggestedCharacterListAdapter.ViewHolder>() {
